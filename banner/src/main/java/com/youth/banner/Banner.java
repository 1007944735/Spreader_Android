...
public class Banner extends FrameLayout implements OnPageChangeListener {
    ...
    public Banner setImages(List<?> imageUrls) {
        ...
        this.count = count + imageUrls.size();
        return this;
    }

    public Banner setVideoUrl(String videoUrl) {
...
//        Log.i(tag,"currentItem: "+currentItem);
    ...
    public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
        if (mOnPageChangeListener != null) {
            ...
            Log.d("banner", "onPageScrolled: " + position);
            Log.d("banner", "onPageScrolled: " + toRealPosition(position));
        }
    }
