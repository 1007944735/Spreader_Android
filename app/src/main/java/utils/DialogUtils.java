...
public class DialogUtils {
    public static void showConfirm(Context context,String title,String msg, String confirm, String cancel, View.OnClickListener confirmOnClick, View.OnClickListener cancelOnClick){
    ...
    public static void showTips(Context context, String title, String msg, String confirm, View.OnClickListener confirmOnClick){
        showConfirm(context,title,msg,confirm,null,confirmOnClick,null);
    }
